...
O editor de código foi escolhido porque ele possui uma integração com o sistema de versão. A ferramenta de gerenciamento utilizada possui integração semelhante e por isso foi selecionada. A ferramenta de comunicação foi selecionada por ser a mesma utilizada nas reuniões com o professor orientador. Por fim, para criar os desenhos de tela utilizamos essa ferramenta por melhor captar as necessidades da nossa solução.
